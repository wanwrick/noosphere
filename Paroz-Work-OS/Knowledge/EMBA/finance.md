...
## 1. Financial Accounting (Prof. Brian White)
...
## 2. Managerial Accounting (Prof. Danny Szpiro)
...
## 3. Managerial Finance (Prof. Mao Ye)
...
## 4. Corporate Financial Policy (Prof. Steven Carvell)

### Capital Structure Theory

**Modigliani-Miller (No Taxes):** Capital structure is irrelevant — firm value is independent of how it's financed.

**M&M (With Taxes):** Debt creates tax shield → optimal structure is 100% debt (in theory).
```
...
## 5. Valuation (Prof. Pamela Moulton)
